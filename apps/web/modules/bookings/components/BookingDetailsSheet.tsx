...
export function BookingDetailsSheet({
  ...
  // Get meeting location info
  const getMeetingLocation = () => {
    if (!booking.location) return null;

    // Check for video conference in references
  ...
  // Format responses for custom questions
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent className="max-w-[484px] overflow-y-auto">
        ...
        <SheetFooter className="bg-muted border-subtle border-t px-6 py-4">
          <SheetClose asChild>
